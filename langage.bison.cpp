...
{
       0,    77,    77,    78,    80,    81,    86,    87,    88,    89,
      90,    91,    94,    91,   103,   104,   105,   106,   107,   108,
     109,   110,   111,   114,   115
};
#endif
...
#line 108 "langage.y"
                         { (yyval.valeur)=(yyvsp[-2].valeur)+(yyvsp[0].valeur);cout<< (yyval.valeur); }
